...
sch:
  chart:
    ...
    metering:
      ...
      productMetric: {{ template "om-chart.metering.prodmetric" . }}
      productChargedContainers: {{ template "om-chart.metering.prodchargedcontainers" . }}
    components:
      dashboard:
        name: {{ template "om-chart.monitoring-dashboard" . }}
{{- end -}}
